...
public class ProjectClient {
    ...
    public static void menu() {
        ...
        System.out.println("    dlt Change the deadline of a task.");
    ...
    public static void add() {
        ...
        if (version(name) > 0) {
            ...
            if (n.equalsIgnoreCase("yes") || n.equalsIgnoreCase("y")) {
                ...
                System.out.println("What is the deadline? e.g. 'Monday 12PM' or '12PM - 6PM'");
                user.nextLine();
                String deadline = user.nextLine();

                Project proj = new Project(name, description, hours, deadline);
                list.add(proj);
                project = proj;
    ...
    public static void changeDeadline() {
        System.out.println("What would you like to change the deadline to?");
        user.nextLine();
        String deadline = user.nextLine();
        ...
        if (deadline == null) {
            ...
            String oldDead = project.getDeadline();
            project.setDeadline(deadline);
            System.out.println("Deadline successfully changed from " + oldDead + " to " + deadline);
        }
